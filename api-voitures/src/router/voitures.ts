...
voituresRouter.post("/create", async (req, res) => {
...
voituresRouter.patch("/update/:id", async (req, res) => {
...
voituresRouter.delete("/delete", async (req, res) => {
  const actual = await prisma.voiture.findFirst({
